                ...
                <div class="col-lg-10 offset-1 col-md-12">
                    <div class="card">
                        <div class="card-block">
                            ...
                            <h6 class="card-subtitle"><code>Hasil Simulasi Data Tahun 2016 Untuk Memprediksi Tahun 2017</code></h6>
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <?php
                                    $no = 1;
                                    $queryrand  = mysqli_query($con, "SELECT tb.nama_bulan, r.bilangan_acak, d.jumlah_pasien FROM tabel_bulan tb, rand_2016 r, data_2017 d WHERE tb.id_bulan = r.id_bulan AND tb.id_bulan = d.id_bulan LIMIT 3") or die(mysqli_error($con));
                                    $queryrange = mysqli_query($con, "SELECT * FROM range_2016") or die(mysqli_error($con));
                                    ...
                                    <tr>
                                      ...
                                      ?>
                                      <td class="text-center"><code><?= @$s = number_format($jumlahpasien) ?></code></td>
                                      <td class="text-center"><?= @$r = number_format($arrayrand['jumlah_pasien']) ?></td>
                                      <?php
