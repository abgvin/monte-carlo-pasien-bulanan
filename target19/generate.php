...
<head>
    ...
    <title>MCSM - Random Number - Target 2019</title>
            ...
            <form action="angkaacak.php" method="post">         
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        ...
                        <button type="submit" name="simpan" class="btn waves-effect waves-light btn-primary pull-right hidden-sm-down" data-toggle="tooltip" data-placement="top" title="Klik Untuk Menyimpan Nilai">Simpan</button>
