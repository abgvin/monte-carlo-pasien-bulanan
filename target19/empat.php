                ...
                <div class="col-lg-10 offset-1 col-md-12">
                    <div class="card">
                        <div class="card-block">
                            ...
                            <h6 class="card-subtitle"><code>Hasil Simulasi Data Tahun 2018 Untuk Memprediksi Tahun 2019</code></h6>
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <?php
                                    $no = 1;
                                    $queryrand  = mysqli_query($con, "SELECT tb.nama_bulan, r.bilangan_acak FROM tabel_bulan tb, rand_2018 r WHERE tb.id_bulan = r.id_bulan LIMIT 3") or die(mysqli_error($con));
                                    $queryrange = mysqli_query($con, "SELECT * FROM range_2018") or die(mysqli_error($con));
