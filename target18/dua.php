...
<head>
    ...
    <title>MCSM - L2 - Target 2018</title>
        ...
        <div class="container">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">Langkah 2</h3>
                    <ol class="breadcrumb">
                ...
                <div class="col-md-7 col-4 align-self-center">
                    <a href="tiga.php" class="btn waves-effect waves-light btn-success pull-right hidden-sm-down" data-toggle="tooltip" data-placement="top" title="Klik Untuk Lanjut Ke Langkah 3"> Next</a>
                    ...
                    <a href="satu.php" class="btn waves-effect waves-light btn-warning pull-right hidden-sm-down" style="margin-right: 20px;" data-toggle="tooltip" data-placement="top" title="Klik Untuk Kembali ke Halaman Sebelumnya"> Back</a>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-block">
                            <h4 class="card-title">Tabel Distribusi Probabilitas Kumulatif</h4>
                                ...
                                <table class="table table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Distribusi Prob</th>
                                            <th class="text-center">Distribusi Prob Kumulatif</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                    ...
                                    $totals = mysqli_query($con, "SELECT SUM(jumlah_pasien) AS total FROM data_2017") or die(mysqli_error($con));
                                    ...
                                    <tfoot class="table-active">
                                        <tr>
                                            ...
                                            <th class="text-center"><?= round($sumdisprob, 2) ?></th>
                                            <th class="text-center"> - </th>
                                        </tr>
                                    </tfoot>
                                </table>
