...
<head>
    ...
    <title>MCSM - L3 - Target 2018</title>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    foreach ($querys as $query) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $query['jumlah_pasien'] ?><input type="hidden" name="jumlahpasienke-<?= $no ?>" value="<?= $query['jumlah_pasien'] ?>" class="form-control text-center input-sm" readonly></td>
